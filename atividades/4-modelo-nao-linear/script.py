...
plt.scatter(in_training, out_training, label='Dados Originais', color='blue', s=100)
plt.scatter(in_training, out_estimated_volterra, color='orange', label='Ajuste', alpha=0.8, s=100)

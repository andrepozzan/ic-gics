...
plt.scatter(in_validation, out_validation, label='Dados Originais', color='blue', s=100)
plt.scatter(in_validation, out_estimated, color='orange', label='Ajuste', alpha=0.8, s=100)
plt.xlabel('in_validation', fontsize=30)
plt.ylabel('out_validation', fontsize=30)
